...
const CENT_TITLE = [
    [
        {cate_no:0, item_no:1, title:'간담췌센터 위ㆍ대장암', icon_src:'medi_w_cetner_1',},
        {cate_no:0, item_no:2, title:'간센터', icon_src:'medi_w_cetner_2',},
        {cate_no:0, item_no:3, title:'감염센터', icon_src:'medi_w_cetner_3',},
        {cate_no:0, item_no:4, title:'대장항문센터', icon_src:'medi_w_cetner_4',},
        {cate_no:0, item_no:5, title:'소아청소년 정신건강센터', icon_src:'medi_w_cetner_5',},
        {cate_no:0, item_no:6, title:'소화기내신경센터', icon_src:'medi_w_cetner_6',},
        {cate_no:0, item_no:7, title:'소화기암수술센터', icon_src:'medi_w_cetner_7',},
        {cate_no:0, item_no:8, title:'신경센터', icon_src:'medi_w_cetner_8',},
        {cate_no:0, item_no:9, title:'심뇌혈관센터', icon_src:'medi_w_cetner_9',},
        {cate_no:0, item_no:10, title:'알레르기 센터', icon_src:'medi_w_cetner_10',},
        {cate_no:0, item_no:11, title:'암재활프로그램', icon_src:'medi_w_cetner_11',},
        {cate_no:0, item_no:12, title:'여성암센터', icon_src:'medi_w_cetner_12',},
        {cate_no:0, item_no:13, title:'유방ㆍ갑상선암 센터', icon_src:'medi_w_cetner_14',},
        {cate_no:0, item_no:14, title:'유방암센터', icon_src:'medi_w_cetner_14',},
        {cate_no:0, item_no:15, title:'응급의료센터', icon_src:'medi_w_cetner_15',},
        {cate_no:0, item_no:16, title:'인공신장센터', icon_src:'medi_w_cetner_16',},
        {cate_no:0, item_no:17, title:'인터벤션센터(중재시술)', icon_src:'medi_w_cetner_17',},
        {cate_no:0, item_no:18, title:'장례식장', icon_src:'medi_w_cetner_18',},
        {cate_no:0, item_no:19, title:'재활치료센터', icon_src:'medi_w_cetner_19',},
        {cate_no:0, item_no:20, title:'전립선ㆍ배뇨장애 센터', icon_src:'medi_w_cetner_20',},
        {cate_no:0, item_no:21, title:'전립선암센터', icon_src:'medi_w_cetner_21',},
        {cate_no:0, item_no:22, title:'척추관절센터', icon_src:'medi_w_cetner_22',},
        {cate_no:0, item_no:23, title:'초음파진단센터', icon_src:'medi_w_cetner_23',},
        {cate_no:0, item_no:24, title:'췌장담도센터', icon_src:'medi_w_cetner_24',},
        {cate_no:0, item_no:25, title:'턱얼굴수술센터(양악센터)', icon_src:'medi_w_cetner_25',},
        {cate_no:0, item_no:26, title:'폐암수술센터', icon_src:'medi_w_cetner_26',},
        {cate_no:0, item_no:27, title:'항암방사선치료센터', icon_src:'medi_w_cetner_27',},
        {cate_no:0, item_no:28, title:'호스피스완화의료병동', icon_src:'medi_w_cetner_28',},
        {cate_no:0, item_no:29, title:'호흡기센터', icon_src:'medi_w_cetner_29',},
    ]
]
const HOSPI_TITLE = [
    [
...
//         ], 
//             sub_context1: [
//                 '온종합병원은 간, 담도계 및 췌장내 악성종야에 대해 풍부한 임상경험과 전문지식을 갖춘 소화기내과, 종양내과, 간담췌외과, 방사선종양학과, 영상의학과, 병리과 전문의들이 주축이 되어 전문의들이 모여 진단에서부터 치료까지 환자중심의 유기적인 협조체계를 구축하고 상호 협력함으로서 환자의 빠른 진단 및 환자 개개인에 맞는 최장의 치료를 제공 하고 있습니다.',
...
//                 '온 종합병원 대장항문센터는 최소침습수술을 비롯하여 다양한 방법을 통하여 환자들에게 치료의 기회를 제공하고 있습니다.',
...
//                 '이런 상황에서 온 종합병원 대장항문센터는 우수한 대장항문 전문 의료진을 모시고 최첨단 의료장비를 활용하여 최고 수준의 진료를 제공합니다. 같은 질병이라도 환자의 상태에 따라서, 또 같은 환자에게라도 질병의 진행에 따라서 최적의 진료가 다를 수 있습니다.',
//                 '현대화와 서구화가 계속 될수록 대장항문 질환은 늘어 갈 것으로 예상됩니다. 대장암은 지난 10년간 가장 많이 증가된 암으로 우리나라 발생 암 중 4번째에 해당되고, 앞으로도 지속적으로 증가하고 있습니다.',
//                 '온 종합병원 대장항문센터는 대장항문질환에 대한 정확한 지식을 전달하고, 상담하며, 환자에 대해서는 최적의 치료를 시행하려고 노력하고 있습니다.',
...
//             ],
//             sub_context1: [
//                 '온 종합병원 신경센터는 뇌와 척수(중추신경), 말초신경 및 근육에 발생하는 질환을 진단하고 치료하며 신경계 질환의 원인을 규명하고 나은 치료방법을 연구하고 있습니다.', 
...
//              '뿐만 아니라 유방암센터 전문 간호사가 유방암 환자의 심리 교육 및 재활 교육을 통해 유방암 환자의 삶의 질 향상을 돕고 있습니다.'
//             ] },
//         {cate_no:0, 
//             item_no:14,
//              img_src:'women_.png', 
...
//              '재활치료센터는 기능의 장애를 가진 사람들을 평가하고 치료하여, 주어진 조건하에서 이들의 신체적, 정신적, 사회적 능력과 취미, 직업, 교육 등의 잠재적 능력을 최대한 발달시켜 정상에 가까운 생활을 할 수 있게 해 주기 위한 전문치료센터입이다.'
//             ] },
//         {cate_no:0, 
//             item_no:20,
//              img_src:'20_.jpg', 
...
//              '온종합병원 턱ㆍ얼굴(악안면)수술센터는 최신의 장비를 이용하여 수술전 분석(2D cephalometry/3D CT/model 분석)을 시행하여 환자 개인에 맞는 최상의 수술계획을 수립하고 있습니다.',
//              '환자중심의 전문센터 One-stop/ One-way(외래/수술준비/입원/수술)시스템 및 턱ㆍ얼굴(악안면)수술환자을 위한 1인실/2인실 입원시스템 그리고 복잡한 과정(접수/대기/반복내원)을 줄여 불편감을 최소로 하였습니다.',
//              '온종합병원 턱얼굴수술센터는 최고 수준의 진료를 제공하기 위하여 구강악안면외과 의료진을 중심으로 이비인후과 전문의, 마취통증 의학과 전문의 등 체계화된 협진체제로 구성되어 정확한 평가와 치료와 수술 후 최상의 결과를 제공하고 있다.',
//             ]},
//         {cate_no:0, 
//             item_no:26,
//              img_src:'26_.jpg', 
...
//              '다만, 상급병실료나 특진비 등 비급여 항목은 일부의 비용을 부담할 수 있습니다.',
...
//             ],
//             sub_context1:[
//              '주요 진료 분야는 만성 폐쇄성 폐질환, 기관지 천식, 폐암, 폐렴, 폐결핵, 만성기침, 기관지 확장증, 간질성 폐 질환, 호흡부전, 흉막 질환(기흉, 흉막염, 흉수, 농흉), 식도암, 종격동 종양, 다한증, 오목가슴, 기관 협착 등이며 폐암 진단 시 정기적이고 지속적인 관리를 해드립니다. 저희 호흡기센터 의료진 모두는 환자분들 편에 서서 여러분의 고통을 해결해 드리기 위해 최선을 다할 것으로 약속드립니다.',
//              '호흡기센터는 호흡기내과와 흉부외과로 구서오디어 있어 질병의 정확한 진단, 치료 및 수술까지 빠르고 정확하게 진료할 수 있습니다.', 
//              '또한 관련 진료과와 협진을 통해 여러 분야의 전문의들이 모여 환자 중심의 진료를 받을 수 있습니다.',
//              '우리 사회의 고령화 추세가 높아지면서 호흡기계 중증 질환자의 수가 급격하게 증가하고 있습니다.',
//              '이처럼 호흡기계 질환자의 증가에 따라 효율적인 진료를 위해 호흡기센터를 개설, 운영하고 있습니다.'
//             ] },
//     ]
// ]
