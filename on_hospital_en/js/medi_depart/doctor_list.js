const DOCTOR = [
    [
        ...
        {   cate_no:0, 
            ...
            one_speci_con:'Comprehensive health check-up / Gastrointestinal endoscopy / Health consultation', 
            ...
            professional: ['Comprehensive health check-up / Gastrointestinal endoscopy / Health consultation'],
        },
        {   cate_no:0,
            item_no:2,
            img_src:'fam_medi2', 
            ...
            one_speci_con:'Comprehensive health check-up / Gastrointestinal endoscopy / Obesity clinic (metabolic syndrome) / Health consultation', 
            morn_schedule:['수술/검사','수술/검사','수술/검사','수술/검사','수술/검사','수술/검사'], 
            afte_schedule:['진료','','진료','진료','',''], 
            morn_color: ['cir_danger','cir_danger','cir_danger','cir_danger','cir_danger','cir_danger',], 
            afte_color: ['cir_primary','','cir_primary','cir_primary','',''],
            ...
            professional: ['Comprehensive health check-up / Gastrointestinal endoscopy / Obesity clinic (metabolic syndrome) / Health consultation'],
        },
        {   cate_no:0,
            item_no:3,
            img_src:'fam_medi4', 
            ...
            one_speci_con:'Comprehensive health check-up / Gastrointestinal endoscopy / Ultrasonography / Management of chronic diseases / Obesity clinic / Metabolic syndrome', 
            morn_schedule:['수술/검사','수술/검사','수술/검사','수술/검사','수술/검사','수술/검사'], 
            ...
            professional: ['Comprehensive health check-up / Gastrointestinal endoscopy / Ultrasonography / Management of chronic diseases / Obesity clinic / Metabolic syndrome'],
        }
    ],
    [
    ...
    [
        ...
        {   cate_no:2,
            ...
            afte_schedule:['중환자실','','중환자실','중환자실','중환자실','문의'], 
    ...
    [
        ...
        {   cate_no:3,
            ...
            one_speci_con:'Chronic diseases (hypertension, diabetes, hyperlipidemia), infectious diseases, upper gastrointestinal endoscopy, upper abdominal ultrasound, carotid artery ultrasound, osteoporosis', 
            ...
            professional: ['Chronic diseases (hypertension, diabetes, hyperlipidemia), infectious diseases, upper gastrointestinal endoscopy, upper abdominal ultrasound, carotid artery ultrasound, osteoporosis'],
        },
        {   cate_no:3,
            item_no:7,
    ...
    [
        ...
        morn_schedule:['진료','진료','진료','진료','진료','문의'], 
        afte_schedule:['진료','수술/검사','진료','진료','수술/검사',''], 
        morn_color: ['cir_primary','cir_primary','cir_primary','cir_primary','cir_primary','cir_success'], 
        ...
        morn_schedule:['수술/검사','수술/검사','진료','수술/검사','수술/검사','문의'], 
        afte_schedule:['진료','수술/검사','진료','진료','진료',''], 
    ...
    [
        ...
        one_speci_con:'Coronary artery disease, acute myocardial infarction (percutaneous coronary intervention), hypertension, hyperlipidemia, heart failure, valvular heart disease (echocardiography)', 
        morn_schedule:['진료','수술/검사','수술/검사','진료','수술/검사','문의'], 
        afte_schedule:['','진료','진료','','진료',''], 
    ...
    [
        ...
        medi_his_con:'Specialist in internal medicine at Kosin University Hospital', 
        one_speci_con:'Chronic diseases (hypertension, diabetes, hyperlipidemia), infectious diseases, upper gastrointestinal endoscopy, upper abdominal ultrasound, carotid artery ultrasound, osteoporosis, B,C형간염, 갑상선질환', 
        ifram_src: 'https://www.youtube.com/embed/TwL--bpEov4', 
        morn_schedule:['진료','진료','진료','진료','진료','문의'], 
        afte_schedule:['진료','진료','','진료','진료',''], 
        morn_color:['cir_primary','cir_primary','cir_primary','cir_primary','cir_primary','cir_success',], 
        ...
        phamacology:['부산의대졸 의학박사','Specialist in internal medicine at Kosin University Hospital'],
        activity: ['대한소화기내시경 학회 정회원','한국초음파학회 정회원','한국심초음파학회 정회원','대한검진의학회 정회원'],
        professional: ['Chronic diseases (hypertension, diabetes, hyperlipidemia), infectious diseases, upper gastrointestinal endoscopy, upper abdominal ultrasound, carotid artery ultrasound, osteoporosis, B,C형간염, 갑상선질환'],
    },
    ],
    [
