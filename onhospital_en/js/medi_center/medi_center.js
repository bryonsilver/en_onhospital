                ...
                cent_list += `<div class="mr_c_content cent_13">
                        ...
                        cent_list+= `
                                        ...
                                        <div class="col-lg-12 top_banner">
                                            <div class="top">
                                                ...
                                                <div class="cont ml-lg-4">
                                                    <h3 class="mb-3 color_funeral title2">
                                                        <img src="./img/guide/funeral.jpg" alt="" class="f_img medi_center_f_img">
                                                    ...
                                                    <h5 class="call_box">
                                                        <span class="call_box_span medi_center_call_box_span">
                                                            <div class="img_box_call"><img src="./img/guide/funeral_call.svg" alt="" class="call_svg"></div>
                                            ...
                                            <div class="section1">					
                                                <ul class="row best_box">
                                                    <li class="col-lg-6 best_re">
                                                        <h5 class="mb-3 pl-5 color_funeral"> <b class="section1_span">Operated directly  </b> by ON Hospital.</h5>
                                                    </li>
                                                    <li class="col-lg-6 best_re">
                                                        <h5 class="mb-3 pl-5 color_funeral"> It is <b class="section1_span"> cheaper than the city funeral homes </b> in Busan.</h5>
                                                    </li>
                                                    <li class="col-lg-6 best_re">
                                                        <h5 class="mb-3 mb-lg-0 pl-5 color_funeral"> There is no additional burden beyond the <br><b class="section1_span">official costs due to honest operation.</b></h5>
                                                    </li>
                                                    <li class="col-lg-6 best_re">							
                                                        <h5 class="mb-3 mb-lg-0 pl-5 color_funeral"> Fresh boiled pork <span> prepared by</span><b class="section1_span"> the chef </b> upon ordering.</h5>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-4 margin_b">
                                        <div class="col-lg-12">
                                            <h3 class="color_funeral font-myeongjo text-center" style="line-height: 1.6;">We will always do our best with a noble and solemn heart to provide a comfortable funeral home <span>where the family can remember the life of their loved one in the most beautiful way.</span></h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg">
                                                            ...
                                                            <p class="t_text_p">
                                                                ...
                                                                <span class="t_inner_text">
                                                                    <span class="name" style="max-width: 300px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;" title="${CENT_LIST[0][cen_v].writer[j]}">
                                                                        <span>${CENT_LIST[0][cen_v].writer[j]}</span>
...
//                 </div>`
    ...
    if (cen_v == 0 || cen_v ==1 || cen_v == 2 || cen_v == 10 || cen_v == 11 || cen_v == 14 || cen_v == 20 || cen_v == 17 || cen_v == 28 || cen_v == 29) {
